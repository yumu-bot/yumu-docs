...
| **STB** | 稳定 | 与玩家的全连成绩占比以及最好成绩 <HopeIcon icon="ranking-star"/> 评级有关。越高，说明玩家全连图的能力相较于同水平的玩家更高。 |
| **PRE** | 彩率 | 仅 osu!mania 存在。<br />与玩家最好成绩的 <HopeIcon icon="barcode"/> 彩率有关。越高，说明玩家抓彩判定能力相较于同水平的玩家更高。 |
...
- **<HopeIcon icon="address-card"/> 玩家名**：同上。
  - 不输入默认查询自己所属的战队信息。
- **<HopeIcon icon="hashtag"/> 战队号**：战队的编号。
