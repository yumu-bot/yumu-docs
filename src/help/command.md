...
| EC | !ec (message) | [Echo](./bot.md/#echo) | 回声 | *仅管理员使用* |
...
| MR | !mr **[mid]** (user) (`#`num) | [Match Recent](./tournament.md/#matchrecent) | 查询比赛成绩 | - |
...
| RB | !rb (`:`mode) (user) | [Recent Best](./score.md/#recentbest) | 查询最近较好成绩 | - |
| RO | !ro **[mid]** (position/keyword) | [Match Round](./tournament.md/#round) | 查询对局信息 | **position**: 对局位置<br />**keyword**: 关键词 |
| RV | !rv | [Revoke](./bot.md/#revoke) | 撤回消息 | *必须回复需要操作的消息* |
...
| S* | !so/!sf/!sl (qq/group) (functions) | [Switch](./bot.md/#switch) | 切换服务开关 | *也可以禁用不需要的服务* |
| TK | !tk (user) | [Take](./aid.md/#take) | 查询玩家名状态 | - |
| TM | !tm (user) (`#`tid) | [Team](./player.md/#team) | 查询战队 | - |
| TP | !tp (`:`mode)  (page) | [Top Plays](./score.md/#topplays) | 查询顶流成绩 | *最多 20 页* |
| TR | !tr **[tone]** | [Transfer](./aid.md/#trans) | 大调转换 | *根据十二平分律计算* |
| XA | !xa **[song/id]** | [mai audio](./maimai.md/#maiaudio) | 试听舞萌歌曲 | - |
| X* | !xc/!xp (user) (`#`num) | [mai filter](./maimai.md/#maifilter) | 查询舞萌全连、完美成绩 | - |
